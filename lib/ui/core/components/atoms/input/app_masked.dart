...
class AppMasked extends TextEditingController {
  ///
  AppMasked({
    this.mask,
    this.beforeChange,
    ...
    this.translator = translator ?? AppMasked.getDefaultTranslator();
  ...
  void updateText(String newText) {
    if (mask != null) {
      ...
      final oldMask = _previousMask ?? mask!;
      final $mask = mask!;
      final oldText = _lastUpdatedText;
      final previousCursor = _lastCursor;

      _lastUpdatedText = _applyMask($mask, newText);
