...
abstract class HomeLocalizations {
  ...
  /// No description provided for @helloVisitor.
  ///
  /// In pt, this message translates to:
  /// **'Olá visitante!'**
  String get helloVisitor;
  ...
  /// No description provided for @needLogged.
  ///
  /// In pt, this message translates to:
  /// **'Para criar um grupo você precisar está logado!'**
  String get needLogged;

  /// No description provided for @myDatas.
  ///
  /// In pt, this message translates to:
  /// **'Meus dados'**
  String get myDatas;
